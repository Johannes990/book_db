...
pub struct AppLanguage {
    ...
    pub event_open_insert_raw_sql_popup: String,
    ...
    pub event_insert_column: String,
    pub event_remove_column: String,
    ...
    #[allow(dead_code)]
    pub screen_splash_avg_system_cpu_usage: String,
    #[allow(dead_code)]
    pub screen_splash_avg_system_memory_usage: String,
    pub screen_splash_avg_proc_cpu_usage: String,
    pub screen_splash_avg_proc_memory_usage: String,
    #[allow(dead_code)]
    pub screen_splash_avg_render_call_duration: String,
